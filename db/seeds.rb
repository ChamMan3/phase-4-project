...
e3=Event.create!(event_type: "funeral", name:"Roadhog's funeral", time: 1140, start: 1, end: 10)
e4=Event.create!(event_type: "memorial", name:"Roadhog's memorial", time: 1145, start: 2, end: 10)
